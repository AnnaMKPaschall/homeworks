...
function (_React$Component) {
  ...
  _createClass(Widget, [{
    ...
    value: function fetchJobListings(city) {
      var proxyUrl = 'https://cors-anywhere.herokuapp.com'; // first, forward the request to a proxy server that allows cross-origin-requests

      var jobsUrl = "https://jobs.github.com/positions.json?location=".concat(city, "&markdown=true"); //

      $.ajax({
        crossDomain: true,
        dataType: 'json',
        // set dataType to json since the jobs.github endpoint is json 
